...
ZVM_Boolean
zvm_compare_string(char *str1, char *str2)
{
...
ZVM_Boolean
zvm_compare_package_name(char *p1, char *p2)
{
    return zvm_compare_string(p1, p2);
}
...
void
zvm_strncpy(char *dest, char *src, int buf_size)
{
    int i;
...
int main(int argc, char **argv)
{
    ...
    status = zvm_search_file(search_path, file_name, found_path, &fp);
